...
type Party struct {
	...
	Hostess              int32     `protobuf:"varint,5,opt,name=hostess,proto3" json:"hostess,omitempty"`
...
type Order struct {
	...
	Status               Order_Status `protobuf:"varint,2,opt,name=status,proto3,enum=models.Order_Status" json:"status,omitempty"`
...
type Content struct {
	Alcohol              []*Alcohol `protobuf:"bytes,1,rep,name=alcohol,proto3" json:"alcohol,omitempty"`
	Snack                []*Snack   `protobuf:"bytes,2,rep,name=snack,proto3" json:"snack,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (m *Content) GetAlcohol() []*Alcohol {
	if m != nil {
		return m.Alcohol
	}
	return nil
...
type Alcohol struct {
	Type                 Alcohol_Alcohol `protobuf:"varint,1,opt,name=type,proto3,enum=models.Alcohol_Alcohol" json:"type,omitempty"`
...
func (m *Alcohol) GetType() Alcohol_Alcohol {
	if m != nil {
		return m.Type
	}
...
type Snack struct {
	Type                 Snack_Snacks `protobuf:"varint,1,opt,name=type,proto3,enum=models.Snack_Snacks" json:"type,omitempty"`
	Amount               int32        `protobuf:"varint,2,opt,name=amount,proto3" json:"amount,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
...
func (m *Snack) GetType() Snack_Snacks {
	if m != nil {
		return m.Type
	}
	return Snack_CHIPS
...
func init() {
	proto.RegisterEnum("models.Order_Status", Order_Status_name, Order_Status_value)
	proto.RegisterEnum("models.Alcohol_Alcohol", Alcohol_Alcohol_name, Alcohol_Alcohol_value)
	proto.RegisterEnum("models.Snack_Snacks", Snack_Snacks_name, Snack_Snacks_value)
	proto.RegisterType((*Party)(nil), "models.Party")
	proto.RegisterType((*Location)(nil), "models.Location")
	proto.RegisterType((*Order)(nil), "models.Order")
	proto.RegisterType((*Content)(nil), "models.Content")
	proto.RegisterType((*Alcohol)(nil), "models.Alcohol")
	proto.RegisterType((*Snack)(nil), "models.Snack")
}
...
var fileDescriptor_b3cd75d7e545703e = []byte{
	...
	,
}
